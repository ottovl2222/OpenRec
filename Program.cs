    ...
    class Program
    {
        ...
        Tutorial:
            if (Setup.firsttime == true)
            {
                ...
                Console.Title = "NetRec Intro";
                Console.WriteLine("Welcome to NetRec " + appversion + "!");
                Console.WriteLine("Is this your first time using NetRec?");
                Console.WriteLine("Yes or No (Y, N)");
                string readline22 = Console.ReadLine();
                if (readline22 == "y" || readline22 == "Y")
                {
                    Console.Clear();
                    Console.Title = "NetRec Tutorial";
                    Console.WriteLine("In that case, welcome to NetRec!");
                    Console.WriteLine("NetRec is server software that emulates the old servers of previous RecRoom versions.");
                    Console.WriteLine("To use NetRec, you'll need to have builds aswell!");
                    ...
                    Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Update/builds.txt"));
        ...
        Start:
            Console.Title = "NetRec Startup Menu";
            Console.ForegroundColor = ConsoleColor.Blue;
            Console.WriteLine("NetRec - Open source Old RecRoom server software. (Version: " + appversion + ")");
            Console.WriteLine("Made and provided by Jacob.");
            Console.WriteLine("Download source code here: https://github.com/JacobRR123/OpenRec");
            Console.WriteLine("Discord: https://discord.gg/daC8QUhnFP" + Environment.NewLine);
            if (!(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Download/version.txt").Contains(appversion)))
            {
                Console.WriteLine("This version of NetRec is outdated. We recommend you install the latest version, NetRec " + new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Download/version.txt"));
            }
            if (File.Exists("SaveData\\Profile\\userid.txt"))
            {
                if (new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Update/banned.txt").Contains(File.ReadAllText("SaveData\\Profile\\userid.txt")))
                {
                    ...
                    Console.WriteLine("You are banned. Using this version of NetRec will not work, please download NetRec 0.4.2 or prior.");
                    Console.ForegroundColor = ConsoleColor.Green;
                    bannedflag = true;
                }
            }
            ...
            if (readline == "1")
            {
                Console.Title = "NetRec Changelog";
                Console.Clear();
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Download/changelog.txt"));
            ...
            if (readline == "2")
            {
                ...
                Settings:
                Console.Title = "NetRec Settings Menu";
                ...
                {
                    Console.Title = "NetRec Custom Room Downloader";
                    Console.Clear();
            ...
            Profile:
                Console.Title = "NetRec Profile Menu";
                ...
                else if (readline3 == "2")
                {
                    ...
                    else if (readline4 == "2")
                    {
                        ...
                        {
                            Console.Clear();
                            Console.WriteLine("Invalid Image (Make sure its on the same drive as NetRec)");
                            goto Profile;
                        }
                        Console.Clear();
                        Console.WriteLine("Success!");
                ...
                {
                    Console.Title = "NetRec Profile Downloader";
                    Console.Clear();
                    Console.WriteLine("Profile Downloader: This tool takes the username and profile image of any username you type in and imports it to NetRec.");
            ...
            if (readline == "4")
            {
                Console.Title = "NetRec Build Downloads";
                Console.Clear();
                Console.WriteLine("To download builds, either go to the builds channel or use the links below: (these links are also available from the #builds channel)" + Environment.NewLine);
                Console.WriteLine(new WebClient().DownloadString("https://raw.githubusercontent.com/JacobRR123/OpenRec/master/Update/builds.txt"));
                Console.WriteLine("Download a build and press any key to continue:");
            ...
            if (readline == "5")
            {
                ...
                {
                    Console.Title = "NetRec October 19th 2017";
                    version = "2017";
                    Console.Clear();
                ...
                else if (readline2 == "2018")
                {
                    ...
                    {
                        Console.Title = "NetRec May 30th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "NetRec September 27th 2018";
                        version = "2018";
                        Console.Clear();
                    ...
                    {
                        Console.Title = "NetRec July 20th 2018";
                        version = "2018";
                        Console.Clear();
